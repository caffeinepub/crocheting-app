...
export class Backend implements backendInterface {
    ...
    async addPattern(arg0: string, arg1: Array<string>, arg2: Array<Material>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPattern(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addProject(arg0: string, arg1: string, arg2: string, arg3: Array<ExternalBlob>, arg4: Array<Material>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProject(arg0, arg1, arg2, await to_candid_vec_n8(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPattern(arg0: string): Promise<CrochetPattern | null> {
        if (this.processError) {
            try {
    ...
    async getPatterns(): Promise<Array<CrochetPattern>> {
        if (this.processError) {
            try {
    ...
    async getProjectMaterials(arg0: string): Promise<Array<Material>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjectMaterials(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProjects(arg0: Principal): Promise<Array<Project>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjects(arg0);
                return from_candid_vec_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProject(arg0: string, arg1: Array<ExternalBlob>, arg2: bigint, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProject(arg0, await to_candid_vec_n8(this._uploadFile, this._downloadFile, arg1), arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Project_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Project): Promise<Project> {
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        time_spent_minutes: value.time_spent_minutes,
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Project>): Promise<Array<Project>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Project_n13(_uploadFile, _downloadFile, x)));
}
